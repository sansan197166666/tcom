...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("议启宝".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["61.111.130.167"];
pub const RS_PUB_KEY: &str = "S0+ts3aDL0wYjLutgNgWWiCfYUtYIIGDXl1zetej5zY=";
pub const RENDEZVOUS_PORT: i32 = 63046;
pub const RELAY_PORT: i32 = 63047;
pub const WS_RENDEZVOUS_PORT: i32 =63048;
pub const WS_RELAY_PORT: i32 = 63049;
