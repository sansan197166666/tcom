...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("联宝议".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["107.148.148.217"];
pub const RS_PUB_KEY: &str = "S0+ts3aDL0wYjLutgNgWWiCfYUtYIIGDXl1zetej5zY=";
pub const RENDEZVOUS_PORT: i32 = 42666;
pub const RELAY_PORT: i32 = 42667;
pub const WS_RENDEZVOUS_PORT: i32 =42668;
pub const WS_RELAY_PORT: i32 = 42669;
