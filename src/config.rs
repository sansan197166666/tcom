...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("议启通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["104.37.212.45"];
pub const RS_PUB_KEY: &str = "S0+ts3aDL0wYjLutgNgWWiCfYUtYIIGDXl1zetej5zY=";
pub const RENDEZVOUS_PORT: i32 = 63036;
pub const RELAY_PORT: i32 = 63037;
pub const WS_RENDEZVOUS_PORT: i32 =63038;
pub const WS_RELAY_PORT: i32 = 63039;
