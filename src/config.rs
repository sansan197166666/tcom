...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("迅唔".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["61.111.130.161"];
pub const RS_PUB_KEY: &str = "S0+ts3aDL0wYjLutgNgWWiCfYUtYIIGDXl1zetej5zY=";
pub const RENDEZVOUS_PORT: i32 = 62986;
pub const RELAY_PORT: i32 = 62987;
pub const WS_RENDEZVOUS_PORT: i32 =62988;
pub const WS_RELAY_PORT: i32 = 62989;
